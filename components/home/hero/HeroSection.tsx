              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
                ...
                <Link href="/cas-client">
                  <Button
                    size="sm"
                    variant="outline"
                    className="px-8 py-4 sm:px-6 sm:py-3 lg:px-8 lg:py-4 text-base sm:text-base lg:text-lg font-semibold bg-[var(--color-main)] hover:bg-white text-white hover:text-[var(--color-main)] rounded-full h-16 sm:h-12 lg:h-14"
                  >
