...
const ModernButton: React.FC<ModernButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      {icon || (
        <svg
          className="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-50 text-[var(--color-main)] ease-linear duration-300 rounded-full border border-gray-700 group-hover:border-none p-2 rotate-45"
          viewBox="0 0 16 19"
